...
<title>Yuechen Fu - Java Web Developer & Plsql Developer</title>
      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            <h1>Yuechen Fu</h1>
            <p>Java Web Developer & Plsql Developer</p>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <p>I am a Java web programmer from China, and I have worked for many years so that make me a good thinking and good summary. Good at grasping customer needs, summing up knowledge points, and communicating with customers in a timely manner.</p>
          <p>I like sports , especily to play basketball. I like to make friends to everyone.</p>
...
<div id="portfolio">
  <div class="container">
    <div class="section-title text-center center">
      ...
      <h5>Below is some projects I have ever done.</h5>
    </div>
   <div></div>
    <div class="row">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/property/pages/index.jsp" title="Buy / sell house "  target="_blank" >
              ...
              <img src="../img/portfolio/project-sell-home.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/recurit/index/" title="Seeking or hire job" target="_blank" >
              <div class="hover-text">
                ...
                <small>Web Design</small> </div>
              <img src="../img/portfolio/project-recurit.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/etrade/index/" title="invoke etrade api" target="_blank">
              <div class="hover-text">
                <h4>Etrade API</h4>
                <small>Web Design</small> </div>
              <img src="../img/portfolio/project-etrade.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/edu/index.html" title="education"  target="_blank" >
              <div class="hover-text">
                <h4>Edu web site</h4>
                <small>Web Design</small> </div>
              <img src="../img/portfolio/project-edu.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 app">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/foodOne/index.html" title="restaurant reservation" target="_blank">
              ...
              <img src="../img/portfolio/project-restrant-reservation.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/foodTwo/index.html" title="Restaurant Online order" target="_blank">
              <div class="hover-text">
                ...
                <small>Web Design</small> </div>
              <img src="../img/portfolio/project-online-order.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/examples/index.html" title="Examples " target="_blank">
              <div class="hover-text">
                ...
                <small>Web Design</small> </div>
              <img src="../img/portfolio/project-examples.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg"> <a href="http://www.gitib.com/" title="Examples " target="_blank">
              <div class="hover-text">
                ...
                <small>Web Design</small> </div>
              <img src="../img/portfolio/project-commerice.png" class="img-responsive" alt="Project Title"> </a> </div>
          </div>
        </div>
      </div>
    </div>
...
<div id="footer">
  <div class="container text-center">
    <div class="fnav">
      <p>Copyright &copy; 2018 Yuechen Fu / kaitlyn061108@gmail.com</p>
    </div>
  </div>
</div>
