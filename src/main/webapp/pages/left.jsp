        ...
        <nav class="custom-scrollbar">
            ...
            <ul class="drp-sec">
                <li class="has-drp">
                    ...
                    <ul class="sb-drp">
                        <li>
                            <a href="pricing-plan.html" title="">All Agents</a>
                        </li>
                        <li>
                            <a href="grids.html" title="">Add Agent</a>
                        </li>
                        <li>
                            <a href="calendar.html" title="">Manage Agent</a>
                        </li>
                ...
                <li class="has-drp">
                    ...
                    <ul class="sb-drp">
                        <li>
                            <a href="font-awesome-icons.html" title="">All Orders</a>
                        </li>
                        <li>
                            <a href="themify-icons.html" title="">Order Analysis</a>
                        </li>
                    </ul>
                </li>
            </ul>
