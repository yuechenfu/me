...
<body class="expand-data panel-data">
   <!-- Topbar -->
    ...
    <div class="pg-tp">
        ...
        <div class="pr-tp-inr">
            <h4>Agent Delete</h4>
            <span>Delete agent information  in the washington .</span>
            ...
            <table class="table table-inverse">
                ...
                <tbody>
                  <c:forEach var="agent" items="${agentList}" varStatus="status">
                    <tr>
                        <td><a href ="${pageContext.request.contextPath }/agent/delete/${agent.id }" ><i class="fa fa-trash"></i></a></td>
                        <td><a href="${pageContext.request.contextPath }/agent/detail"><img src="../${agent.photoUrl }" width="40px" height="40px"></a></td>
